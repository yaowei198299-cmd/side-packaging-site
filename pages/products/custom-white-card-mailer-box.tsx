...
const WhiteCardMailerPage = () => {
  return (
    <div className="min-h-screen bg-black text-white font-sans selection:bg-gold-500 overflow-x-hidden">
      <Head>
        <title>Custom White Card Mailer Box | Premium E-commerce & Subscription Packaging</title>
        <meta name="description" content="Custom mailer box with logo printing. High-quality white card paper packaging for e-commerce, gift subscription, and retail. Eco-friendly and recyclable." />
      </Head>
      ...
      <section className="relative h-screen flex items-center pt-20 overflow-hidden">
        <div className="absolute inset-0 z-0">
          <img 
            ...
            alt="Custom White Card Mailer Box" 
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6">
          <div className="max-w-3xl">
            ...
            <p className="text-xl text-white/60 mb-12 max-w-xl font-medium tracking-tight uppercase tracking-widest leading-relaxed">
              Custom Logo Printing. High-End Finish. Perfect for Subscription Boxes & Retail Delivery.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid lg:grid-cols-2 gap-32 items-start">
                ...
                <div className="space-y-12">
                   <div className="grid grid-cols-2 gap-10">
                      <div>
                         ...
                         <p className="text-lg font-bold text-white/80">350gsm - 400gsm White Cardboard</p>
                      </div>
                      <div>
                         <p className="text-[10px] font-black text-[#d4af37] uppercase tracking-widest mb-3">Printing</p>
                         <p className="text-lg font-bold text-white/80">CMYK / Pantone Full Color</p>
                      </div>
                   </div>
                   <div className="grid grid-cols-2 gap-10">
                      <div>
                         <p className="text-[10px] font-black text-[#d4af37] uppercase tracking-widest mb-3">Finishing</p>
                         <p className="text-lg font-bold text-white/80">Matte/Glossy Lamination, Spot UV</p>
                      </div>
                      <div>
                         <p className="text-[10px] font-black text-[#d4af37] uppercase tracking-widest mb-3">Feature</p>
                         <p className="text-lg font-bold text-white/80">100% Recyclable & Eco-Friendly</p>
                      </div>
                   </div>
                   <div className="grid grid-cols-2 gap-10 border-t border-white/5 pt-10">
                      ...
                      <div>
                         ...
                         <p className="text-lg font-bold text-white/40 italic">10-12 Working Days</p>
                      </div>
                   </div>
                </div>
             </div>
             ...
             <div className="bg-[#0f0f15] p-12 border border-white/5 rounded-sm">
                <h3 className="text-2xl font-black uppercase tracking-tighter italic mb-8">Industry Applications</h3>
                <ul className="space-y-6 text-sm font-bold uppercase tracking-[0.2em] text-white/60">
                   <li className="flex items-center gap-4 border-l border-[#d4af37] pl-6">Subscription Box Services</li>
                   <li className="flex items-center gap-4 border-l border-[#d4af37] pl-6">E-commerce Shipping & Logistics</li>
                   <li className="flex items-center gap-4 border-l border-[#d4af37] pl-6">Luxury Retail Packaging</li>
                   <li className="flex items-center gap-4 border-l border-[#d4af37] pl-6">Bespoke Gift Packaging</li>
                </ul>
             </div>
          </div>
        </div>
