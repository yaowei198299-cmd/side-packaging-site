...
const ProductDetail = () => {
  return (
    <div className="min-h-screen bg-white text-black font-sans selection:bg-blue-100">
      <Head>
        <title>Premium Mailer Box | E-commerce Shipping Packaging | Side Packaging</title>
      ...
      <main className="max-w-7xl mx-auto px-6 py-24">
        <div className="grid lg:grid-cols-2 gap-24 items-center mb-32">
          <div className="aspect-square bg-gray-50 rounded-[40px] flex items-center justify-center p-24">
            <img src="/assets/mailer-box.svg" alt="Mailer Box" className="w-full h-full object-contain" />
          </div>
          <div>
        ...
        <section className="bg-blue-600 rounded-[50px] p-24 text-center text-white">
          ...
          <p className="text-xl opacity-80 mb-12 max-w-2xl mx-auto font-medium">Custom printed mailer boxes are the #1 way to build brand recognition in the direct-to-consumer market.</p>
