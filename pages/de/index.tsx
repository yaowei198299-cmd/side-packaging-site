...
const HomePageDe = () => {
  const boxStyles = [
    { title: "Starre Magnetbox", image: "https://sc04.alicdn.com/kf/H28aff4222df5454fbde2704bbee757e90.jpg?v=1", link: "/products" },
    { title: "Schubladenbox", image: "https://sc04.alicdn.com/kf/Hdf03eb602caa4dd4bce2e15c8f77cb1aA.jpg?v=1", link: "/products" },
    { title: "Versandkarton", image: "https://sc04.alicdn.com/kf/H4d0f3440368f42ec86490f55e64be502P.jpg?v=1", link: "/products" },
    { title: "Kosmetik-Faltschachtel", image: "https://images.unsplash.com/photo-1612817288484-6f916006741a?q=80&w=800", link: "/products" },
    { title: "Luxus-Papiertüte", image: "https://sc04.alicdn.com/kf/H689a746594d24194910903328f4d9526n.jpg?v=1", link: "/products" },
    { title: "Bespoke Geschenkset", image: "https://sc04.alicdn.com/kf/Hc9d42403e05342a58b8875eb53436ec4E.jpg?v=1", link: "/products" },
  ];

  const factoryTrust = [
    { label: "Werksgeschichte", value: "20+ Jahre" },
    { label: "Zertifizierungen", value: "FSC / BSCI / ISO" },
    { label: "Produktionskapazität", value: "50k Stück/Tag" },
    { label: "Globale Präsenz", value: "50+ Länder" },
  ];

  return (
    <div className="min-h-screen bg-black text-white font-sans selection:bg-gold-500 overflow-x-hidden">
      <Head>
        <title>Side Packaging | High-End Luxus-Fabrik direkt | Maßgeschneiderte Lösungen</title>
        <meta name="description" content="Side Packaging HK Limited: Premium B2B-Fertigung für Luxus-Magnetboxen, Mailer und maßgeschneiderte Verpackungen. Direkt ab Werk seit 2006." />
      </Head>

      {/* Navbar */}
      <nav className="fixed top-0 left-0 right-0 z-[100] bg-black/40 backdrop-blur-2xl border-b border-white/5">
        <div className="max-w-7xl mx-auto px-6 h-24 flex items-center justify-between">
          <Link href="/de" className="text-2xl font-black tracking-tighter uppercase italic text-white">Side Packaging</Link>
          <div className="hidden lg:flex items-center space-x-12 text-[10px] font-black uppercase tracking-[0.4em] text-gray-400">
            ...
            <Link href="/about-founder" className="hover:text-white transition-colors">Über uns</Link>
            <Link href="/blog" className="hover:text-white transition-colors">Einblicke</Link>
          </div>
          <a href="#contact" className="bg-white text-black px-10 py-3.5 rounded-full text-[10px] font-black uppercase tracking-widest hover:bg-gray-200 shadow-xl transition-all">Angebot</a>
        </div>
      </nav>
      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-20 text-center max-w-5xl px-6">
          <div className="inline-flex items-center gap-3 bg-white/5 border border-white/10 px-6 py-2 rounded-full mb-10 backdrop-blur-lg">
            ...
            <span className="text-[10px] font-black uppercase tracking-[0.3em] text-white/60">Direkt ab Werk · Leitfaden 2026</span>
          </div>
          ...
          <p className="text-xl md:text-2xl text-white/50 mb-16 max-w-2xl mx-auto font-medium leading-relaxed uppercase tracking-widest">
            Maßgeschneiderte Verpackungstechnik für globale Premiummarken.
          </p>
        ...
        <div className="max-w-[1600px] mx-auto px-6">
          <header className="flex flex-col md:flex-row md:items-end justify-between gap-12 mb-32 border-b border-white/5 pb-20">
            <div className="max-w-2xl">
              <h2 className="text-5xl md:text-7xl font-black uppercase tracking-tighter leading-none mb-8 italic">Struktur & <br/>Finish.</h2>
              <p className="text-gray-500 font-medium leading-relaxed uppercase tracking-widest text-sm">Jede Box ist ein technisches Meisterwerk.</p>
            </div>
            <Link href="/products" className="text-[11px] font-black uppercase tracking-[0.4em] text-white border-b border-gold-500 pb-2 hover:text-gold-500 transition-colors">Technische Daten →</Link>
          </header>
            ...
            {boxStyles.map((box, i) => (
              <Link key={i} href={box.link} className="group relative block aspect-[4/5] overflow-hidden bg-[#0f0f0f] rounded-sm border border-white/5 hover:border-white/10 transition-all">
                ...
                <div className="absolute bottom-10 left-10 right-10">
                  ...
                  <p className="text-[9px] font-black text-white/40 uppercase tracking-[0.4em]">FSC-zertifiziert · Technisches Design</p>
                </div>
              </Link>
            ))}
          </div>
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <div className="grid lg:grid-cols-2 gap-40">
            <div>
              ...
              <p className="text-xl text-white/40 mb-20 font-medium leading-relaxed uppercase tracking-[0.2em]">Kostenoptimierung innerhalb von 24 Stunden.</p>
              
              <div className="space-y-16">
                <div>
                  <p className="text-[10px] font-black text-gold-500 uppercase tracking-widest mb-4">E-Mail</p>
                  <p className="text-3xl font-black italic">jocelyn@saidepackaging.com</p>
                </div>
                <div>
                  <p className="text-[10px] font-black text-gold-500 uppercase tracking-widest mb-4">Support</p>
