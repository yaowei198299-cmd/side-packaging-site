...
const ProductsPage = () => {
  const categories = [
    {
      ...
      desc: "Hochdichte 1200g Graupappe mit erstklassigen, maßgeschneiderten Oberflächen.",
      items: [
        {
          badge: "ÖKO-LUXUS",
          title: "Das Ewige Öko-Luxus-Set",
          desc: "FSC-zertifizierte Öko-Luxus-Beauty-Geschenkbox mit Steinpapier-Soft-Touch-Oberfläche und 100% plastikfreien, maßgeschneiderten Myzel-Formeinsätzen.",
        ...
        },
        {
          ...
          desc: "Premium matt-schwarze Magnetdeckelbox mit präzise geformtem Schaumstoffeinsatz. Ideal für Pflegesets und Hautpflege.",
        ...
        },
        {
          ...
          desc: "Klassische zweiteilige Hartkartonbox mit einer vorgebundenen Satinschleife. Perfekt für Luxusschmuck und Geschenksets.",
        ...
        },
        {
          ...
          desc: "Kraft-Wellpappen-Versandkarton mit integriertem Aufreißstreifen für sofortiges Öffnen. Nachhaltiges und langlebiges Unboxing-Erlebnis.",
        ...
        },
        {
          ...
          title: "Premium Weißkarton-Versandbox",
          desc: "Hochwertiger Versandkarton aus weißem Karton mit individuellem Logodruck. Langlebig, stilvoll und 100% recycelbar für erstklassigen E-Commerce-Versand.",
        ...
        },
        {
          ...
          desc: "Faltbarer High-End-Faltschachtel-Karton mit erstklassigen Oberflächen. Entwickelt für Beautymarken, die Effizienz bei der Flachverpackung ohne Kompromisse beim Luxus benötigen.",
    ...
    },
    {
      ...
      desc: "Eleganz für den gehobenen Einzelhandel, Schmuck und Spezialmarken.",
      items: [
        {
          badge: "PREMIUM",
          title: "Rosa Leder-Schmuckkästchen",
          desc: "Premium-Leder-Finish mit einem sanft gleitenden Schubladen-Organizer. Ideal für hochwertige Ringe und Boutique-Schmuck.",
        ...
        },
        {
          ...
          desc: "Hochwertige magnetische Hartkartonbox mit exquisiten Blattgold-Details. Entwickelt für Premium-Geschenksets.",
        ...
        {
          badge: "INDIVIDUELL",
          title: "Papiertüten mit Bandgriff",
          desc: "Elegante Papiertüten mit weichen Bandgriffen und verstärktem Boden. Perfekt für Luxus-Einzelhandel und Boutiquen.",
        ...
        },
        {
          ...
          desc: "Umweltfreundliche und FSC-zertifizierte fettbeständige Papier-Sets. Nachhaltig und stilvoll für handwerkliche Marken.",
  ...
  return (
    <div className="min-h-screen bg-black text-white font-sans selection:bg-gold-500">
      <Head>
        <title>Verpackungskatalog | Luxus-Maßgeschneiderte Lösungen | Side Packaging HK Limited</title>
        <meta name="description" content="Entdecken Sie unseren technischen Verpackungskatalog. Industriespezifikationen, MOQ und Lieferzeiten für Luxus-Hartkartonboxen und Einzelhandelslösungen." />
      </Head>
      ...
      <main className="pt-40 pb-24 bg-gradient-to-b from-black to-gray-900">
        <div className="max-w-[1600px] mx-auto px-6">
          <header className="mb-24">
            <h1 className="text-5xl font-black uppercase tracking-tighter mb-4 italic">Maßgeschneiderter Katalog</h1>
            <p className="text-gray-500 font-medium">Technische Spezifikationen für die professionelle B2B-Beschaffung.</p>
          </header>
      ...
      <footer className="bg-black text-white py-16 border-t border-white/5">
        <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row justify-between items-center gap-12">
          <div className="flex flex-col gap-4">
             ...
             <p className="text-[10px] font-bold uppercase tracking-widest text-gray-600">Premium B2B-Fertigungslösungen.</p>
          </div>
          <p className="text-[10px] font-bold uppercase tracking-widest text-gray-600">&copy; 2026 Side Packaging HK Limited. FSC & BSCI zertifiziert.</p>
        </div>
      </footer>
    </div>
  );
