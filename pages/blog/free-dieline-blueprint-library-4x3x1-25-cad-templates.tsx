        ...
        <div className="max-w-4xl mx-auto px-6">
          ...
          <article className="space-y-16">
            ...
            <section className="space-y-8">
              ...
              <div className="grid md:grid-cols-2 gap-8">
                <div className="bg-white/5 border border-white/10 p-10 rounded-[2.5rem] group hover:border-[#C9A84C]/50 transition-all">
                  ...
                  <a href="#contact" className="text-[#C9A84C] font-black uppercase text-[10px] tracking-widest border-b border-[#C9A84C] pb-2 group-hover:text-white group-hover:border-white transition-all">Download AI/PDF Blueprint &rarr;</a>
                </div>
                <div className="bg-white/5 border border-white/10 p-10 rounded-[2.5rem] group hover:border-[#C9A84C]/50 transition-all">
            ...
            <section className="py-16 border-t border-white/5">
              <h2 className="text-3xl font-black uppercase tracking-tighter italic mb-12 text-center font-montserrat">Request a Pallet Density Audit</h2>
