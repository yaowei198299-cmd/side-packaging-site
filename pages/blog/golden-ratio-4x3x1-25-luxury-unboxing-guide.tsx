                ...
                <table className="w-full text-left border-collapse border border-white/5 text-xs md:text-sm uppercase tracking-wider">
                  ...
                  <tbody className="text-gray-400 font-medium">
                    <tr className="border-b border-white/5">
                      ...
                      <td className="p-4 border-r border-white/5">🟢 High (Jewel-box feel)</td>
                    ...
                    <tr className="border-b border-white/5">
                      ...
                      <td className="p-4 border-r border-white/5">🟢 Effortless (Ergonomic grip)</td>
                    ...
                    <tr>
                      ...
                      <td className="p-4 border-r border-white/5">🟢 High (Travel-sized)</td>
