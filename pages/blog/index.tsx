  ...
  const posts = [
    {
      ...
      excerpt: "A procurement guide for 4 x 3 x 1.25 inch rigid magnetic jewelry boxes, covering insert fit, magnetic closure, board construction, sample validation, and landed-cost inputs.",
    ...
    },
    {
      ...
      excerpt: "Compare white-faced and kraft corrugated mailers for subscription packaging, including inside-and-out printing, packaging validation, dimensional weight, and freight inputs.",
      date: "September 22, 2026",
    ...
    },
    {
      ...
      excerpt: "An evidence-led supplier guide for FSC, plastic-free, and recyclable cosmetic packaging, covering BOM documentation, coatings, inks, inserts, weight formulas, and claim boundaries.",
      date: "September 22, 2026",
