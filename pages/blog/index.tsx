  ...
  const posts = [
    {
      ...
      excerpt: "A procurement guide for 4 x 3 x 1.25 inch rigid magnetic jewelry boxes, covering insert fit, closure validation, board construction, sample testing, and landed-cost inputs.",
    ...
    },
    {
      ...
      excerpt: "Compare white-faced and kraft corrugated mailers for subscription packaging, including inside-and-out printing, proof validation, dimensional weight, and freight inputs.",
      date: "September 23, 2026",
