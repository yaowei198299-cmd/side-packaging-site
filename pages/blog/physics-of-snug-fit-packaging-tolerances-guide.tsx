                ...
                <table className="w-full text-left border-collapse border border-white/5 text-xs md:text-sm uppercase tracking-wider">
                  ...
                  <tbody className="text-gray-400 font-medium">
                    <tr className="border-b border-white/5">
                      ...
                      <td className="p-4 border-r border-white/5">卤 0.05 mm</td>
                      <td className="p-4 border-r border-white/5">馃煝 0.15 mm</td>
                    ...
                    <tr className="border-b border-white/5">
                      ...
                      <td className="p-4 border-r border-white/5">卤 0.20 mm</td>
                    ...
                    <tr>
                      ...
                      <td className="p-4 text-green-500 font-bold">馃煝 High-friction security</td>
                    </tr>
                  </tbody>
                </table>
              </div>
