...
const GalleryPage = () => {
  ...
  const projects = [
    { title: "Luxury Magnetic Perfume Box", category: "Magnetic", image: "/assets/products/product_4f33629d.jpg", tags: ["FSC", "Gold Foil"] },
    { title: "Bespoke Jewelry Set Box", category: "Jewelry", image: "/assets/products/product_f3bfee3b.jpg", tags: ["Velvet", "Small MOQ"] },
    { title: "Premium Kraft Mailer", category: "Mailer", image: "/assets/products/product_87781449.jpg", tags: ["Sustainable", "Durable"] },
    { title: "Lid & Base Gift Box", category: "Lid & Base", image: "/assets/products/product_004c0690.jpg", tags: ["Rigid", "Art Paper"] },
    { title: "Cosmetic Sliding Drawer", category: "Drawer", image: "/assets/products/product_24f6b5b2.jpg", tags: ["Soft Touch", "Spot UV"] },
    ...
    { title: "Custom Watch Rigid Box", category: "Rigid Setup", image: "/assets/products/product_3a5c13f5.jpg", tags: ["Luxury", "Industrial"] },
    { title: "Electronics Accessory Box", category: "Cosmetic", image: "/assets/products/product_11d0ea86.jpg", tags: ["Embossed", "Seal"] },
    { title: "Triangle Snack Box", category: "Food", image: "/assets/products/product_0ae8fe62.jpg", tags: ["Unique Shape", "Magnetic"] },
    { title: "Flower Bouquet Rigid Box", category: "Rigid Setup", image: "/assets/products/product_65fbeb58.jpg", tags: ["Illustration", "Handmade"] },
    { title: "Laser Cut Macaron Box", category: "Rigid Setup", image: "/assets/products/product_3aec85e4.jpg", tags: ["Laser Cut", "Mini"] },
    { title: "Folding Kraft Gift Folder", category: "Folding", image: "/assets/products/product_236b6c48.jpg", tags: ["Folder", "Reusable"] }
  ];
             ...
             <div className="grid lg:grid-cols-2 gap-24 items-center">
                <div>
                 ...
                 <div className="aspect-[4/5] bg-white/5 rounded-[4rem] border border-white/10 overflow-hidden relative shadow-2xl">
                    <img src="/assets/products/product_92a4d2be.jpg" alt="Optimization Result" className="w-full h-full object-cover   group-hover:-0 transition-all" />
